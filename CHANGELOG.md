...
Extracted `@rcrsr/rill-config` from the [rill monorepo](https://github.com/rcrsr/rill) into a standalone repository. No functional changes from the monorepo version.
